        ...
        <section className="w-full bg-[#f3f3f1] overflow-hidden">
            <div className="w-full max-w-[1512px] mx-auto px-[36px] pt-[32px] pb-[40px] flex justify-between gap-[30px]">
                <div className="w-[58%] pt-[44px]">
                    ...
                    >
                        <p className="mt-[17px] mb-0 text-black text-[74px] leading-none" style={{ fontFamily: "Dorsa, sans-serif" }}>
                            BY DARIN'S
                        </p>
                        <div className="w-[360px] h-[5px] bg-black mt-[10px]" />
                    </motion.div>

                    <motion.div
                        className="mt-[54px] ml-[250px] flex items-center gap-4"
                    ...
                    >
                        <motion.button
                            ...
                            whileTap={{ scale: 0.96 }}
                            className="relative inline-flex w-[330px] h-[76px] items-center justify-center rounded-full bg-[#140000] text-white text-[34px] tracking-[0.18em] cursor-pointer border-none overflow-hidden"
                            style={{ fontFamily: "Dorsa, sans-serif" }}
                        >
                            <motion.span
